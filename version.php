...
$plugin->version   = 2019012401;        // The current plugin version (Date: YYYYMMDDXX).
$plugin->maturity  = MATURITY_STABLE;  // Maturity level.
$plugin->component  = 'qformat_csv';  // Plugin name.
$plugin->release  = '3.6.02 (Build: 2019012401)';  // The current module release in human-readable form (x.y).
